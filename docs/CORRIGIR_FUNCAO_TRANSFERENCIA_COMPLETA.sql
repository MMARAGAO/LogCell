...
-- Data: 06/12/2025
-- =====================================================
-- Problema: Função não atualiza confirmado_em e confirmado_por
-- Solução: Adicionar esses campos no UPDATE
-- =====================================================
...
BEGIN
  ...
  -- 3. Atualizar status da transferência COM confirmado_em e confirmado_por
...
SELECT 'Função confirmar_transferencia corrigida com sucesso!' as resultado;
