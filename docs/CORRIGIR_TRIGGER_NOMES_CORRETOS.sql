-- ============================================
-- CORRIGIR TRIGGER - NOMES DE COLUNAS CORRETOS
-- ============================================
...
BEGIN
  ...
  -- ============================================
  -- Se atualizado_por está preenchido, apenas atualiza controle
  -- ============================================
  
  IF NEW.atualizado_por IS NOT NULL THEN
    RAISE NOTICE '⏭️ Operação controlada, apenas atualizando estado';
    ...
    -- NOMES CORRETOS: produto_id, loja_id, estado, quantidade_atual
  ...
  -- Buscar estado anterior (nome correto: estado)
...
SELECT '✅ Trigger corrigida com nomes corretos!' as status;
