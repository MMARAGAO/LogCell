-- ==========================================
-- CORRIGIR ENCODING UTF-8 NAS NOTIFICAÇÕES
-- ==========================================

-- Recriar função com encoding correto
...
COMMENT ON FUNCTION public.criar_notificacao_estoque IS 
'Cria notificações inteligentes de estoque apenas em mudanças de estado. Sem acentos para evitar problemas de encoding UTF-8.';

-- Testar
SELECT 'Função atualizada com sucesso! ✅' as resultado;
