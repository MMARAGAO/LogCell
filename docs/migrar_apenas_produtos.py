"""
Script de Migração - APENAS PRODUTOS
====================================
Migra apenas os produtos (sem estoque) do banco antigo para o novo
"""
...
def confirmar():
    ...
    print("   ❌ NÃO migra quantidades em estoque")
...
def main():
    ...
    try:
        ...
        migrar_produtos()
        exibir_resumo()
        log("\n🎉 MIGRAÇÃO DE PRODUTOS CONCLUÍDA!", "SUCCESS")
        log("➡️  Próximo passo: executar script de migração de estoque", "INFO")
