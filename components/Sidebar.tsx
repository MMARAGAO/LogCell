...
const menuSections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: "Vendas de Aparelhos",
        href: "/sistema/vendas/aparelhos",
        permissao: "aparelhos.visualizar" as const,
        icon: DevicePhoneMobileIcon,
        iconSolid: DevicePhoneMobileIconSolid,
      },
    ...
    items: [
      {
        ...
        permissao: "configuracoes.gerenciar" as const,
        icon: CogIcon,
...
function SidebarContent({
  ...
  return (
    <>
      {!hideHeader && (
        <div
          className={`flex items-center h-16 shrink-0 border-b border-zinc-200/80 dark:border-zinc-700/80 ${collapsed ? "justify-center" : "px-5 gap-4"}`}
        >
          {!collapsed && (
            <button
            ...
            >
              ...
              <div className="min-w-0 text-left">
                <span className="font-bold text-base tracking-tight text-zinc-900 dark:text-white block truncate">
                  LogCell
                </span>
          ...
          {isDesktop && onToggleCollapse && (
            ...
            >
              ...
              <div className="absolute left-[48%] top-1/2 z-10 flex h-3 w-3 -translate-y-1/2 items-center justify-center">
                <motion.div
                  animate={
                    collapsed ? { x: "-94%", rotate: 180 } : { x: 0, rotate: 0 }
                  }
      ...
      <nav className="flex-1 overflow-y-auto px-2 py-4 scrollbar-thin">
        <div className="space-y-5">
          {menuSections.map((section) => {
            const visibleItems = menuLoading
              ? []
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between px-4 h-16 shrink-0">
          ...
          <button
            aria-label="Fechar menu"
            className="lg:hidden p-1.5 text-zinc-400 hover:text-zinc-600 rounded-lg hover:bg-zinc-100"
            onClick={onClose}
          >
